\begin{Figure}
    ...
    \end{tikzpicture}
    \captionof{figure}{Frames of reference. The angular frequency $w_{\odot}$ only contributes to the tangential component of the velocities of the stars in the Sun's frame of reference, and is therefore omitted in equation \ref{eq:ReferenceFrame}.}\label{fig:FrameOfReference}
\end{Figure}