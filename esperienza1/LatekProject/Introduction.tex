...
We utilized the MCMC (Monte Carlo Markov Chain) implementation from the emcee package in Python~\cite{EMCEE} to estimate the posterior distributions of both models.
